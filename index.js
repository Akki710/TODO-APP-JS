let todoItems = [];// empty array which wil contain our card's element as proprty of this array

let currentChange;
let flag = true;


// default initialisation and setting the blurring of page
...
// create the html part of the card and setting todoItems in it
...
// functionality done on markDone button
...
// function to create a todo oject and then push it to our empty array
function addTodo() {
...
// functionality done on add button of second popup which will add list item in card
function addSubTodo() {
...
// functioning done on trash icon button for deleting card
...
// functioning done on add item button of main page for opening of 1st popup and creating blur
function toggle() {
  var blur;
  if (flag) {
...
// functioning done on + icon which will open second popup for adding list item
...
// functionality done on clicking the heading of card to go to list card page
...
// functionality done on Back button to redirect to main page
function goBack() {
  flag = true;
  renderTodo();
}